...
- **Collapse/expand is instant** (the flat list drops collapsed descendants, so the grid-rows slide can't survive); node-selection tints **full-width** rows. Both deliberate (ADR 0019).
