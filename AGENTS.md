...
- **`index.ts`** — the **one explicit, ordered array** `plugins = [code, links, tags, todos]`. Add a plugin = add a folder + one line here (no `import.meta.glob`). Array order is the precedence tiebreak and the dispatch order.
