...
export interface ApiTypes {
    agent: {
        fireAgentRun: FunctionReference<"action", { userId: string; questionNodeId: string }, { runId: string; status: "running"; answerRootId?: undefined; } | { runId: string; status: "cancelled"; answerRootId?: undefined; } | { runId: string; status: "error"; answerRootId?: undefined; } | { runId: string; status: "completed"; answerRootId: string | undefined; }>;
    };
}
